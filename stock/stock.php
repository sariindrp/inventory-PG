    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../logopg.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="merk">Expired</label>
                                                            <input type="date" id="merk" name="merk" class="form-control" value="<?php echo $p['exp'] ?>">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
								...
								<div class="form-group">
									<label>Expired</label>
									<input name="merk" type="date" class="form-control" placeholder="Expired">
								</div>
								<div class="form-group">
									<label>Ukuran</label>
								...
								<div class="form-group">
									...
									<option value="Unit">Dusan</option>
									</select>
								</div>
								<div class="form-group">
									<label>Lokasi</label>
