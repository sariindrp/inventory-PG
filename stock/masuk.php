						...
						<div class="modal-body">
							<form action="barang_masuk_act.php" method="post">
								...
								<div class="form-group">
									...
									?>
										<option value="<?php echo $d['idx'] ?>"><?php echo $d['nama'] ?> <?php echo $d['jenis'] ?>, Uk. <?php echo $d['ukuran'] ?></option>
										<?php
								}
								?>
									</select>
								...
								<div class="form-group">
									<label>Expired</label>
									<input name="ket" type="date" class="form-control" placeholder="Keterangan">
								</div>
